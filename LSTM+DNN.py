...
def create_directory_structure():
    base_dir = "lstm_dnn_ablation_study"
    subdirs = [
        "models",
        "plots/optimization",
        "plots/performance",
...
# ======================
# MODEL ARCHITECTURE (LSTM + DNN ONLY)
# ======================
def create_model(hyperparams, input_shape):
    ...
    optimizer = optimizers.Adam(
        ...
        clipvalue=0.5  # Gradient clipping for LSTM
    )
...
def objective(trial):
    hyperparams = {
        ...
        'dnn_units': trial.suggest_categorical('dnn_units', [256, 512, 768]),
...
# To load and predict:
predictions, probs = load_and_predict("lstm_dnn_ablation_study/models/final_model.keras", X_test)
